...
def action_client():
    ...
    goal_tasks.tasks = [
         Task(type="RECOGNIZE", object="objects", location=""),
 #       Task(type="RECOGNIZE", object="objects", location="unspecified"),
 #       Task(type="RECOGNIZE", object="chili pepper", location="unspecified"),
 #       Task(type="RECOGNIZE", object="carrot", location="unspecified"),
 #       Task(type="RECOGNIZE", object="bell pepper", location="unspecified"),
    ]
    #goal_tasks.tasks = [Task(type="RECOGNIZE", object="floor", location="")]
