...
int main(int argc, char **argv) 
{
    ...
    while (ros::ok()) 
    {
        ...
        if((timestamp_now - time_grid_map)>2 && path_theta_published || (timestamp_now - time_local_map)>2 && path_theta_published || (timestamp_now - time_mpc)>2 && path_theta_published)
        {
